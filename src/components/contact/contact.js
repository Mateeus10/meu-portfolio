        ...
        <div class="ways-contact">
          ...
          <ul class="list-icons">
            <li>
             ...
             <a href="mailto:mateeus.almeida10@gmail.com"><p>mateeus.almeida10@gmail.com</p></a>
            </li>
            <li>
             <i class="fa fa-location-dot" id="icon-contact"></i>
             <p class="mg-icon-2">Suzano, São Paulo - Brasil</p>
            </li>
          </ul>
        </div>
        <form action="https://formsubmit.co/b8074444c018ffecaba8442d8d2b3ddc" method="POST" class="form-contact">
